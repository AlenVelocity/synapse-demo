...
import { createContext, useContext, useState, ReactNode, FunctionComponent, useCallback, useMemo } from 'react'
...
const DeepgramContextProvider: FunctionComponent<DeepgramContextProviderProps> = ({ children }) => {
	...
	return <DeepgramContext.Provider value={contextValue}>{children}</DeepgramContext.Provider>
}
